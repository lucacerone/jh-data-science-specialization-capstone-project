...
```{r}
unlink("../data/en_US_ngrams/2ngrams_full_non_aggregated.tsv")
for ( i in seq(1, length(lall)) ) {
  cat("Processing file ", sprintf("%03d",i),".\n")
  pt <- get_phrasetable(lall[[i]],2, min_freq = 1)
  write_tsv(pt, "../data/en_US_ngrams/2ngrams_full_non_aggregated.tsv", append = T)
}
```
